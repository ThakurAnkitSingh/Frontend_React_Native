        ...
        <View>
            ...
            {photo.url !== null && (
                <View>
                    ...
                    < TouchableOpacity style={{ width: 60, height: 23, borderWidth: .5, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginTop: 10, marginLeft: 35, backgroundColor: '#ff0000' }} >
                        <Text onPress={() => { replaceImage(photo) }}>Replace</Text>
                    </TouchableOpacity >
                </View>
            )}
